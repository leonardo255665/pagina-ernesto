        ...
        switch (t) {
            case 1: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-success' role='alert'>Se agrego con exito la oveja</div>"
                );
                break;
            case 2: //
                $(".mensaje-alerta").append(
                    "<div class='alert alert-danger' role='alert'>Se elimino la oveja</div>"
                );
                break;
            default:
...
if (dbVacas.length !== 0) {
    ...
    $("#dbVacas-list").append("<h2> No tienes ovejas </h2>");
}
...
function contarVacas(){
    ...
    $("#numeroOvejas").append(
        "<a>Tienes actualmente" + "<br>" + "<span class='badge'>" + nVacas + "</span></a> ovejas"
    );
    return nVacas;
}
...
$(".btnEliminar").bind("click", function(){
    alert("¿ se guro que lo quieres eliminar ?");
...
$(".btnEditar").bind("click", function() {
    alert("¿ seguro que lo quieres editar ?");
    // Cambiamos el modo
